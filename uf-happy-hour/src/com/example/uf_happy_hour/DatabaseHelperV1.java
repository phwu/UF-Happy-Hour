...
public class DatabaseHelperV1 extends SQLiteOpenHelper {
    ...
    private static String DB_NAME = "UFHappyHourDB";
	...
	*/
	...
	public DatabaseHelperV1(Context context) {
	...
	public void onCreate(SQLiteDatabase db) {
	    ...
	    values.put(colName, "Stubbies"); // Contact Name
	    values.put(colAddress, "!23 University"); // Contact Phone Number
	 
	    // Inserting Row
	    db.insert(BarsTable, null, values);
